...
//        System.out.println(affineCipher.decrypt(affineCipher.encrypt(message)) + "\n");
        ...
        RSA rsa = new RSA(256);
//        System.out.println("Public key : " + rsa.getE());
//        System.out.println("Private key : " + rsa.getD());
//        System.out.println(rsa.decrypt(rsa.encrypt("test")));
